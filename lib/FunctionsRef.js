...
var FunctionsRef = /** @class */ (function () {
    function FunctionsRef() {
        ...
        this.getFetchAdvanceByAmountSimulationCallable = function () {
            return (0, functions_1.httpsCallable)((0, functions_1.getFunctions)(), 'fetchAdvanceByAmountSimulation');
        };
        ...
        this.getAdvanceReceivablesByAmountCallable = function () {
            return (0, functions_1.httpsCallable)((0, functions_1.getFunctions)(), 'advanceReceivablesByAmount');
        };
